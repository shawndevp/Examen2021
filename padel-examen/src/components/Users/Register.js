          ...
          <form className="formReg" onSubmit={handleSubmitReg}>
            ...
            {error ? (
              <p className="text-danger">
                Email eller Användarnamn <br /> är redan taget.
              </p>
            ) : (
              <></>
            )}
        ...
        <div className="form-container sign-in-container">
          <form className="formReg" onSubmit={handleSubmitSign}>
            ...
            <span className="spanNr1">
              Med de uppgifter när du skapade ditt konto
            </span>
            <input
              className="inputReg"
              name="identifier"
          ...
          <div className="overlay">
            <div className="overlay-panel overlay-left">
              ...
              <p className="paragraphNr1">
                Vänligen logga in med dina personliga uppgifter
              </p>
            ...
            <div className="overlay-panel overlay-right">
              ...
              <p className="paragraphNr1">
                Ange dina personliga uppgifter och börja din padel resa med oss
                på NackaPDL
              </p>
